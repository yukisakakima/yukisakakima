...
## Languages and Tools:
[![My Skills](https://skillicons.dev/icons?i=linux,html,css,bootstrap,js,typescript,jquery,react,redux,nodejs,ruby,rails,python,flask,go,sqlite,postgresql,docker,heroku,netlify,git,github,githubactions,vscode,visualstudio,markdown,ableton)](https://skillicons.dev)
