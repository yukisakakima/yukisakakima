...
## Languages and Tools:
[![My Skills](https://skillicons.dev/icons?i=linux,html,css,bootstrap,js,typescript,jquery,nextjs,react,ruby,rails,python,flask,go,sqlite,postgresql,docker,heroku,netlify,git,github,githubactions,vscode,markdown,ableton)](https://skillicons.dev)
